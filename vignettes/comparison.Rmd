...
traps_cols <- c("#E5C494", "#252424", "#8DA0CB", "#4a5f92", "#e98962", "#c25a30", "#FFD92F", "#66C2A5")
...
traps_cols_hirst <- c("#E5C494", "#353333", "#252424", "#8DA0CB", "#4a5f92", "#e98962", "#c25a30", "#FFD92F", "#66C2A5")
...
traps_lty_hirst <- c(1, 1, 3, 1, 3, 1, 3, 1, 1)
...
map2(pollen_10, pollen_10_log, function(first, second) {
  ...
  gg_tukey1 <- tibble(
    ...
    geom_abline(slope = 0, intercept = 0, col = traps_cols[2], alpha = 0.9) +
